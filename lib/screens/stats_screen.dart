...
import 'package:wrotto/screens/widgets/indicator.dart';
    ...
    return Scaffold(
      ...
      builder: (context, provider, child) => Padding(
        ...
        child: Column(children: [
          ...
          Text("Total : " + provider.journalEntriesAll.length.toString()),
          Text(
              "Days : " + provider.journalEntriesbyDate.keys.length.toString()),
          AspectRatio(
            aspectRatio: 1.66,
            child: Card(
              elevation: 5,
      ...
      switch (i) {
        case 0:
          return PieChartSectionData(
            ...
            title: provider.moodPercentages[0].toString() + '% 😢',
            radius: radius,
        ...
        case 1:
          return PieChartSectionData(
            ...
            title: provider.moodPercentages[1].toString() + '% 🙁',
            radius: radius,
            titleStyle: TextStyle(
                fontSize: fontSize,
                fontWeight: FontWeight.bold,
        ...
        case 2:
          return PieChartSectionData(
            ...
            title: provider.moodPercentages[2].toString() + '% 😐',
            radius: radius,
            titleStyle: TextStyle(
                fontSize: fontSize,
                fontWeight: FontWeight.bold,
        ...
        case 3:
          return PieChartSectionData(
            ...
            title: provider.moodPercentages[3].toString() + '% 🙂',
            radius: radius,
            titleStyle: TextStyle(
                fontSize: fontSize,
                fontWeight: FontWeight.bold,
        ...
        case 4:
          return PieChartSectionData(
            ...
            title: provider.moodPercentages[4].toString() + '% 😁',
            radius: radius,
            titleStyle: TextStyle(
                fontSize: fontSize,
                fontWeight: FontWeight.bold,
